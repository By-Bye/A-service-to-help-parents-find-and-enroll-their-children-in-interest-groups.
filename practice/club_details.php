        ...
        <main>
            <div class="main">
                ...
                <div class="back-maps">
                    ...
                    <button class="maps" onclick="openMap('<?php
                        $address = htmlspecialchars($club['address']);
                        echo str_replace('г.', '', $address);
                    ?>')">
                        <p>На карте</p>
                    ...
                    <script>
                        function openMap(address) {
                            window.open('map.php?address=' + encodeURIComponent(address), '_blank');
                        }
                    </script>
                </div>
